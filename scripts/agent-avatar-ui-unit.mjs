...
assert.equal(avatar().props["data-initial"], undefined, "loading placeholders contain no text");
succeed();
...
act(() => renderer.unmount());
console.log("PASS shared avatars: transparent image layer, blank loading/failure placeholder, cached image mount, identity/version retry");
